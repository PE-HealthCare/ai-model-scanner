...
Before using any contract schema, apply the rules in `contracts/AGENT_RULES.md`; the schema is the validation artifact, while the contract rules define its governance and authority boundary.
