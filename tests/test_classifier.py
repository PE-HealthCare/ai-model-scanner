...
class TestClassifier(unittest.TestCase):
    ...
    def test_real_classifier_and_tree_shap_contract(self):
        ...
        self.assertEqual(result["producer"],"P3"); self.assertEqual(result["mock_status"],"VERIFIED-REAL")
        self.assertTrue(0.0 <= result["p_tamper"] <= 1.0); self.assertEqual(list(result["shap_attributions"]),list(FEATURE_NAMES))
    ...
    def test_multi_layer_p_tamper_aggregation_is_not_invented(self):
