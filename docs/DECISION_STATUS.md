...
This registry does not authorize silent implementation of D4 or D6 or completion claims for unresolved D9 evidence. D5 Part 7 is now locked; production implementation must reproduce its exact mathematical construction. The frozen architecture remains authoritative.
